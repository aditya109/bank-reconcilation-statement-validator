                        ...
                        <div className="container-second-row">
                            ...
                            <div className="right-arrow-div">
                                ...
                                <svg height="100" viewBox="0 -77 512 512" width="100" xmlns="http://www.w3.org/2000/svg">
                                    <path d="m292.246094 357.222656v-81.195312h-163.1875v-194.832032h163.1875v-81.195312l219.753906 178.613281zm0 0" fill="#999900" />
                                    <g fill="#FFD034">
                        ...
                        <div className="jobs-list-container">
                            ...
                            <div className="container-last-row">
                                ...
                                <div className="control-btn-div">
                                    <button className="add-btn">Add to Job Queue</button>
                                    <button className="reset-btn">Reset Queue</button>
                                </div>
                            </div>
                        </div>
                    </div>
